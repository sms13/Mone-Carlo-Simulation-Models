...
### Overview:
This example simulates and analyzes the Newsvendor Problem.  There is a related Shiny version of this model in Newsvendor_app.R 

*Note: there are several chunks of R code that aren't useful to display in this report, so they don't appear here, but they does appear in the .Rmd file.  For example, I hide the R code that creates functions, initialization of some variables, etc.  It's not particularly interesting for the reader of this report.  One can dig into the .Rmd file itself for this.*
